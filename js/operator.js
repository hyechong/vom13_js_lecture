...
const operater = 5 + 4 * 2;
// console.log(operater);
const operater1 = (5 + 4) * 2;
// console.log(operater1);
...
// 3. 비교 연산자
// 비교 연산자는 boolean (true, false)타입을 리턴한다.
// == : 값이 같다, === : 값과 타입이 같다
// console.log(1 == '1');
// console.log(1 === '1');
...
// // console.log(g); //2
// // g++;
// // console.log(g); //3, ++는 값을 1씩만 증가시킬 수 있음
...
let g = 10;
console.log(g); //10
console.log(++g); //11, 전위 증가연산자 : 값을 먼저 증가한 후 결과를 리턴
console.log(g); //11

let h = 10;
console.log(h); //10
console.log(h++); //10, 후위 증가연산자 : 변수를 먼저 리턴하고 값을 증가
console.log(h); //11
