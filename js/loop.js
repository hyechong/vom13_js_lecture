...
for (let i = 0; i < forinarr.length; i++) {
  // console.log(i); // i 변수는 인덱스(0,1,2...)
  // console.log(forinarr[i]); // a,b,c...
  // const a = forinarr[i];
  a = forinarr[i];
  // console.log(a);
}
console.log(a); // const a는 블럭 안에 있어서 못읽음, a는 재할당되어 밖으로 나오므로 읽어짐 (e)

const name = ['hyeji'];

for (let i = 0; i < 10; i++) {
  console.log(`${name},${i}님 안녕하세요/n`);
}
...
//   //   // console.log(elmt);
//   //   litag.innerHTML = elmt; // litag.textContent로 해도 됨
//   //   navi.append(litag);
